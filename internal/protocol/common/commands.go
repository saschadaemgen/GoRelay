...
func (r Response) Serialize() []byte {
	...
	case CmdMSG:
		...
		// Body is the complete encryptedRcvMsgBody (16122 bytes)
		// Haskell: smpEncode (msgId, Tail body) = shortString(msgId) + rawBody
		// No cleartext timestamp/flags in wire format
		t = append(t, r.Body...)
	case CmdEND:
		t = append(t, TagEND...)
	}
